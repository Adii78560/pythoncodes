...
with open('/home/admin1/bridgelabz_pythonproj/samplejson.json', 'w') as outfile:  # stores data in json file
    json.dump(data, outfile, indent=2)  # indent for cascade format which add spaces

with open('/home/admin1/bridgelabz_pythonproj/samplejson.json', 'r') as f:  # read file
