...
class CliniqueManagement:
    ...
    def read_Json_file_of_Patient(self):
        ...
        with open('../patient.json', 'r') as file_obj:
            json_str = file_obj.read()
            # loads the data and convert it into dictionary format
            json_value = json.loads(json_str)
    ...
    def readJsonfileofAppoinment(self):
        ...
        appoinment_information = {
            "Dr.gautami mhatre": [
                {"patient Name": "Nikhil lad", "Id": 12, "Age": 24, "mobile number": "7865232419", "time": "AM"},
                {"patient Name": "pushkar ishware", "Id": 12, "Age": 34, "mobile number": "8956345213", "time": "AM"}],
            "Dr.madhuri kokate": [
                {"patient Name": "janhavi mhatre", "Id": 14, "Age": 21, "mobile number": "9420036520", "time": "PM"}],
            "Dr.shazad shaikh": [
                {"patient Name": "kimaya mhatre", "Id": 15, "Age": 22, "mobile number": "8976348562", "time": "AM"}],
